...
## 7. Enrolment and academic history
...
- Admission number generation is unique under concurrent creation.
...
Critical suites — results, fees, permissions — block merge on any failure.
